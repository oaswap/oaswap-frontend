...
import { InjectedModalProps } from '@oaswap/uikit'
...
const BuyModal: React.FC<BuyModalProps> = ({ nftToBuy, onDismiss }) => {
  ...
  const wbnbContract = useERC20(tokens.wrose.address)
  ...
  const { balance: wbnbBalance, fetchStatus: wbnbFetchStatus } = useTokenBalance(tokens.wrose.address)
