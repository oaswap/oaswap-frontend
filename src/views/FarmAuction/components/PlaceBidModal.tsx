...
import { Modal, Text, Flex, BalanceInput, Box, Button, PancakeRoundIcon } from '@oaswap/uikit'
...
const PlaceBidModal: React.FC<PlaceBidModalProps> = ({
  ...
  const { balance: userCake, fetchStatus } = useTokenBalance(tokens.oas.address)
